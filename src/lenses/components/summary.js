...
const SummaryComponent = ({ doc_, expanded }) => {
    ...
    return (
        <div className="summaryDiv" style={{ borderColor: color_ }}>
            ...
            <div className="summaryBody_"></div>
            <div className="summarySettings" style={{ backgroundImage: 'linear-gradient(275deg, ' + color_ + ', #ffffff)' }}>
                ...
                <i
                    className="summarySettingsIcon fas fa-sliders-h"
                    title="summarize a specific range of this document"
                    id="summarySlicingIcon"
                ></i>
            </div>
            {/* <p>{doc_.title}</p> */}
        </div>
